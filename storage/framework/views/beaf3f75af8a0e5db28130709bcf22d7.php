        ...
        <div class="modal-content shad-modal">
            <div class="modal-header border-bottom px-6 py-4">
                ...
                <div class="d-flex align-items-center gap-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update-ticket-status')): ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/tickets/partials/ticket-modal.blade.php ENDPATH**/ ?>