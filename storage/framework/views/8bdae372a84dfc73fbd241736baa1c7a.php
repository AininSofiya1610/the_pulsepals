                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="mb-4">
                                ...
                                <p class="font-weight-semibold" style="font-size: 1.125rem; color: var(--slate-800);"><?php echo e($lead->name); ?></p>
                            </div>
                            <div class="mb-4">
                            ...
                            <div>
                                ...
                                <p style="color: var(--slate-700);"><?php echo e($lead->phone ?? 'N/A'); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="mb-4">
                                <p class="shad-stat-label mb-1">Source</p>
                                <span class="shad-badge shad-badge-outline"><?php echo e($lead->source ?? 'N/A'); ?></span>
                            </div>
                            <div class="mb-4">
                                ...
                                ?>
                                <span class="shad-badge <?php echo e($statusData['class']); ?>"><?php echo e($statusData['label']); ?></span>
                            </div>
                            <div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center mr-2" style="width: 28px; height: 28px; font-size: 0.75rem;">
                                        <?php echo e(substr($lead->assignedTo->name ?? 'U', 0, 1)); ?>

                                    </div>
                                    <span style="color: var(--slate-700);"><?php echo e($lead->assignedTo->name ?? 'Unassigned'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex p-3 mb-3 rounded-lg" style="background: var(--slate-50); border-left: 4px solid <?php echo e($activity->type == 'call' ? '#22c55e' : ($activity->type == 'email' ? '#3b82f6' : ($activity->type == 'whatsapp' ? '#25d366' : '#f59e0b'))); ?>;">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <span class="font-weight-medium" style="color: var(--slate-700);"><?php echo e($activity->user->name ?? 'System'); ?></span>
                                    <small class="text-muted"><?php echo e($activity->created_at->format('M d, Y h:i A')); ?></small>
                                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="shad-card mb-4">
                ...
                <div class="shad-card-body">
                    <?php if($lead->status !== 'qualified'): ?>
                        ...
                        <div class="dropdown mb-3">
                            ...
                            <div class="dropdown-menu w-100" style="border-radius: var(--radius-md); box-shadow: var(--shadow-lg);">
                                <?php $__currentLoopData = ['new_lead' => 'New Lead', 'contacted' => 'Contacted', 'negotiation' => 'Negotiation', 'lost' => 'Lost']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <form action="<?php echo e(route('leads.updateStatus', $lead->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="status" value="<?php echo e($status); ?>">
                                        <button type="submit" class="dropdown-item <?php echo e($lead->status == $status ? 'active' : ''); ?>" style="padding: 0.75rem 1rem;">
                                            <?php if($status == 'new_lead'): ?>
                                                <i class="fas fa-seedling text-info mr-2"></i>
                                            <?php elseif($status == 'contacted'): ?>
                                                <i class="fas fa-phone text-primary mr-2"></i>
                                            <?php elseif($status == 'negotiation'): ?>
                    ...
                    <!-- Assign Lead -->
                    <form action="<?php echo e(route('leads.assign', $lead->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-0">
                            ...
                            <select name="assigned_to" class="shad-input" onchange="this.form.submit()">
                                ...
                                <?php $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>" <?php echo e($lead->assigned_to == $user->id ? 'selected' : ''); ?>>
            ...
            <div class="shad-card" style="border: 1px solid #fecaca;">
                <div class="shad-card-body">
                    <form action="<?php echo e(route('leads.destroy', $lead->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this lead? This action cannot be undone.')">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="convertModal" tabindex="-1" role="dialog" aria-labelledby="convertModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="shad-card" style="margin: 0; border: none;">
            ...
            <form action="<?php echo e(route('leads.convert', $lead->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="shad-card-body">
                    <div class="shad-alert shad-alert-info mb-4">
                        <i class="fas fa-info-circle"></i>
                        <span>You are about to convert <strong><?php echo e($lead->name); ?></strong> to a customer.</span>
                    </div>
                    ...
                    <div id="dealFields" class="p-3 rounded-lg" style="background: var(--slate-50);">
                        <div class="mb-3">
                            ...
                            <input type="text" name="deal_title" class="shad-input" value="Opportunity - <?php echo e($lead->name); ?>" placeholder="e.g. Website Project">
                        </div>
                        <div class="mb-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/leads/show.blade.php ENDPATH**/ ?>