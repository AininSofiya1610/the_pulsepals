...
<div class="container-fluid py-4">
    ...
    <div class="shad-page-header">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('vendors.template')); ?>" class="shad-btn shad-btn-ghost">
            ...
            <form action="<?php echo e(route('export.vendors')); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="shad-card">
        <div class="shad-card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="shad-card-description"><?php echo e($vendors->total()); ?> total vendors</p>
            </div>
                ...
                <div class="table-responsive">
                    <table class="shad-table">
                        ...
                        <tbody>
                            ...
                            <tr class="vendor-row" data-search="<?php echo e(strtolower($vendor->vendorName)); ?>">
                                <td class="text-center" style="color: var(--slate-500);"><?php echo e($vendors->firstItem() + $loop->index); ?></td>
                                <td style="font-weight: 600; color: var(--slate-800);"><?php echo e($vendor->vendorName); ?></td>
                                <td class="text-center" style="color: var(--slate-500); font-size: 0.8125rem;">
                                    <?php echo e($vendor->created_at->format('M d, Y')); ?>
                                ...
                                <td>
                                    <div class="shad-actions justify-content-end">
                                        <button class="shad-btn shad-btn-ghost shad-btn-sm delete-btn" 
                                                ...
                                                data-name="<?php echo e($vendor->vendorName); ?>"
                                                style="color: #dc2626;"
                                                title="Delete">
        ...
        <div class="shad-card-footer d-flex justify-content-between align-items-center">
            <small style="color: var(--slate-500);">Showing <?php echo e($vendors->firstItem()); ?> to <?php echo e($vendors->lastItem()); ?> of <?php echo e($vendors->total()); ?></small>
...
<div class="modal fade shad-modal" id="vendorModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('vendors.store')); ?>" method="POST" id="vendorForm">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal-header" style="background: #f0fdf4; border-bottom: 1px solid #bbf7d0;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        <small style="color: #16a34a;"><?php echo e(count($importedRows)); ?> vendor berjaya diimport ke sistem</small>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.8125rem;">
                        ...
                        <tbody>
                            ...
                            <tr style="<?php echo e($loop->odd ? 'background:#fff;' : 'background:#f9fafb;'); ?> border-bottom: 1px solid #f3f4f6;">
                                ...
                                <td style="padding: 0.5rem 0.75rem; font-weight: 600; color: #111827;"><?php echo e($row['vendorName']); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    modal.on('show.bs.modal', function(e) {
        ...
        form.action = '<?php echo e(route("vendors.store")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/vendors/create.blade.php ENDPATH**/ ?>