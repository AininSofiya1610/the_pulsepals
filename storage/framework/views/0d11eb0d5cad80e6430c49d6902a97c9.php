...
<div class="container-fluid py-4">
    ...
    <?php $displayName = $customer->name ?: $customer->customerName ?: 'N/A'; ?>

    <!-- Page Header -->
    <div class="shad-page-header mb-4">
        <div>
            <h1 class="shad-page-title"><?php echo e($displayName); ?></h1>
            <p class="shad-page-description">Customer Profile</p>
        </div>
        <a href="<?php echo e(route('crm.customers.index')); ?>" class="shad-btn shad-btn-secondary">
        ...
        <div class="col-lg-4">
            ...
            <div class="shad-card mb-4">
                ...
                <div class="shad-card-body">
                    <div class="mb-4">
                        ...
                        <p class="font-weight-semibold" style="font-size: 1rem; color: var(--slate-800);"><?php echo e($displayName); ?></p>
                    </div>
                    <div class="mb-4">
                        <p class="shad-stat-label mb-1">Email</p>
                        <p style="color: var(--slate-700);">
                            <?php if($customer->email ?: $customer->customerEmail): ?>
                                <a href="mailto:<?php echo e($customer->email ?: $customer->customerEmail); ?>" class="text-primary"><?php echo e($customer->email ?: $customer->customerEmail); ?></a>
                            <?php else: ?>
                    ...
                    <div class="mb-4">
                        ...
                        <p style="color: var(--slate-700);"><?php echo e($customer->phone ?: $customer->customerPhone ?: 'N/A'); ?></p>
                    </div>
                    <div class="mb-4">
                        <p class="shad-stat-label mb-1">Company</p>
                        <p style="color: var(--slate-700);"><?php echo e($customer->company ?? 'N/A'); ?></p>
                    </div>
                    <div class="mb-4">
                        ...
                        <?php else: ?>
                            <span class="shad-badge shad-badge-gray"><?php echo e($customer->status ?: 'N/A'); ?></span>
                        <?php endif; ?>
                    </div>
                    <?php if($customer->lead): ?>
                        <div>
                            <p class="shad-stat-label mb-1">Created from Lead</p>
                            <p style="font-size: 0.875rem; color: var(--slate-600);">
                                <?php echo e($customer->lead->name); ?> (<?php echo e($customer->created_at->format('M d, Y')); ?>)
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="shad-card mb-4">
                ...
                <div class="shad-card-body">
                    ...
                    <form action="<?php echo e(route('crm.customers.destroy', $customer->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this customer? This will also delete all associated deals and activities.')">
                        <?php echo csrf_field(); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $customer->deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-3 mb-3 rounded-lg" style="background: var(--slate-50); border: 1px solid var(--border-color);">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <a href="<?php echo e(route('deals.show', $deal->id)); ?>" class="font-weight-semibold text-primary mb-1 d-block" style="font-size: 1rem;">
                                        <?php echo e($deal->title); ?>

                                    </a>
                                    <p class="mb-1" style="font-size: 0.875rem; color: var(--slate-600);">
                                        Value: <span style="color: #22c55e; font-weight: 600;">RM <?php echo e(number_format($deal->value, 2)); ?></span>
                                    </p>
                                    <small style="color: var(--slate-400);">Created <?php echo e($deal->created_at->diffForHumans()); ?></small>
                                </div>
                                <div>
                                    <?php
                                        $stageStyles = [
                                    ...
                                    ?>
                                    <span class="shad-badge <?php echo e($stageData['class']); ?>"><?php echo e($stageData['label']); ?></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="shad-card mb-4">
                ...
                <div class="shad-card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $customer->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="d-flex p-3 mb-3 rounded-lg" style="background: var(--slate-50); border-left: 4px solid <?php echo e($activity->type == 'call' ? '#22c55e' : ($activity->type == 'email' ? '#3b82f6' : ($activity->type == 'whatsapp' ? '#25d366' : '#f59e0b'))); ?>;">
                            <div class="mr-3">
                                <?php
                                    $iconStyles = [
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center" 
                                     style="width: 40px; height: 40px; background: <?php echo e($iconData['bg']); ?>;">
                                    <i class="<?php echo e(str_starts_with($iconData['icon'], 'fab') ? $iconData['icon'] : 'fas ' . $iconData['icon']); ?>" 
                                       style="color: <?php echo e($iconData['color']); ?>;"></i>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <span class="font-weight-medium" style="color: var(--slate-700);">
                                        <strong><?php echo e(ucfirst($activity->type)); ?></strong> by <?php echo e($activity->user->name ?? 'System'); ?>

                                    </span>
                                    <small class="text-muted"><?php echo e($activity->created_at->diffForHumans()); ?></small>
                                </div>
                                <p class="mb-0" style="color: var(--slate-600);"><?php echo e($activity->description); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="shad-empty py-4">
                ...
                <form action="<?php echo e(route('customers.update', $customer->id)); ?>" method="POST">
                    ...
                    <div class="shad-card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="shad-input" value="<?php echo e($customer->name ?: $customer->customerName); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="shad-label">Email</label>
                            <input type="email" name="email" class="shad-input" value="<?php echo e($customer->email ?: $customer->customerEmail); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="shad-label">Phone</label>
                            <input type="text" name="phone" class="shad-input" value="<?php echo e($customer->phone ?: $customer->customerPhone); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="shad-label">Company</label>
                            <input type="text" name="company" class="shad-input" value="<?php echo e($customer->company); ?>">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/crm/customers/show.blade.php ENDPATH**/ ?>