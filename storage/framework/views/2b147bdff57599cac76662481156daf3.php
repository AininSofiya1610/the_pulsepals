...
<div class="container-fluid py-4">
    ...
    <div class="shad-page-header">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('vendor.finance.template')); ?>" class="shad-btn shad-btn-ghost">
            ...
            <form action="<?php echo e(route('export.vendor-finance')); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="shad-card mb-4">
        <div class="shad-card-body py-3">
            <form action="<?php echo e(route('vendor.finance.index')); ?>" method="GET" class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <div class="d-flex align-items-center gap-2">
                        <label class="shad-label mb-0">Search:</label>
                        <input type="text" name="search" class="shad-input" style="width: 180px;" value="<?php echo e($search); ?>" placeholder="Invoice, Vendor...">
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <label class="shad-label mb-0">From:</label>
                        <input type="date" name="start_date" id="start_date" class="shad-input date-dmy" style="width: auto;" value="<?php echo e($startDate); ?>">
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <label class="shad-label mb-0">To:</label>
                        <input type="date" name="end_date" id="end_date" class="shad-input date-dmy" style="width: auto;" value="<?php echo e($endDate); ?>">
                    </div>
                    <button type="submit" class="shad-btn shad-btn-primary shad-btn-sm">Filter</button>
                    <a href="<?php echo e(route('vendor.finance.index')); ?>" class="shad-btn shad-btn-ghost shad-btn-sm">Clear</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="shad-card">
        ...
        <div class="shad-card-body p-0">
            <?php if(count($groupedTransactions) > 0): ?>
                <?php $__currentLoopData = $groupedTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $months): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="shad-badge shad-badge-primary" style="font-size: 0.875rem;">
                                        <?php echo e(collect($months)->sum('count')); ?> transactions
                                    </span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex gap-4" style="font-size: 0.875rem;">
                                            <span style="color: var(--slate-600);">
                                                Invoice: <strong style="color: var(--slate-800);">RM <?php echo e(number_format($monthData['total_bill'], 2)); ?></strong>
                                            </span>
                                            <span style="color: #22c55e;">
                                                <i class="fas fa-arrow-up" style="font-size: 0.7rem;"></i>
                                                Paid: RM <?php echo e(number_format($monthData['total_paid'], 2)); ?>
                                ...
                                <div id="month-<?php echo e($year); ?>-<?php echo e($monthNum); ?>" class="collapse <?php echo e($isCurrentMonth ? 'show' : ''); ?>">
                                    <div class="table-responsive">
                                        <table class="shad-table">
                                            ...
                                            <tbody>
<?php $__currentLoopData = $monthData['transactions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
...
?>
                                                <tr class="finance-row">
                                                    ...
                                                    <td style="font-weight: 600; color: var(--slate-800);"><?php echo e($transaction->invoice_no); ?></td>
                                                    <td><?php echo e($transaction->vendor_name); ?></td>
                                                    ...
                                                    <td class="text-right">RM <?php echo e(number_format($transaction->invoice, 2)); ?></td>
                                                    ...
                                                    <td>
                                                        <div class="shad-actions justify-content-end">
                                                            <button class="shad-btn shad-btn-ghost shad-btn-sm view-btn" data-id="<?php echo e($transaction->id); ?>" title="View">
                                                                <i class="fas fa-eye"></i>
                                                            </button>
                                                            <button class="shad-btn shad-btn-ghost shad-btn-sm delete-btn" data-id="<?php echo e($transaction->id); ?>" data-invoice="<?php echo e($transaction->invoice_no); ?>" style="color: #dc2626;" title="Delete">
...
<div class="modal fade shad-modal" id="importModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('vendor.finance.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade shad-modal" id="invoiceModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('vendor.finance.store')); ?>" method="POST" id="invoiceForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="vendor_name" class="shad-select" required>
                                ...
                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($vendor->vendorName); ?>"><?php echo e($vendor->vendorName); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div id="paymentFormSection" style="display: none;">
                    <div class="shad-card mb-3" style="border-left: 3px solid #22c55e;">
                        <div class="shad-card-body">
                            <form action="<?php echo e(route('vendor.finance.payment.store')); ?>" method="POST" id="paymentForm">
                                <?php echo csrf_field(); ?>
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.8125rem;">
                        ...
                        <tbody>
                            ...
                            <tr style="<?php echo e($loop->odd ? 'background:#fff;' : 'background:#f9fafb;'); ?> border-bottom: 1px solid #f3f4f6;">
                                ...
                                <td style="padding: 0.5rem 0.75rem; color: #374151;"><?php echo e($row['vendor_name']); ?></td>
                                <td style="padding: 0.5rem 0.75rem; color: #374151;"><?php echo e($row['invoice_date']); ?></td>
                                <td style="padding: 0.5rem 0.75rem; color: #374151;"><?php echo e($row['due_date']); ?></td>
                                <td style="padding: 0.5rem 0.75rem; text-align: right; color: #111827; font-weight: 600;">RM <?php echo e(number_format($row['invoice'], 2)); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/vendors/finance.blade.php ENDPATH**/ ?>