        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle d-flex align-items-center py-2 px-3" href="#" id="userDropdown" role="button"
                ...
                <div class="mr-3 text-right d-none d-lg-block">
                    <span class="d-block" style="font-weight: 500; font-size: 0.875rem; color: #18181b; line-height: 1.2;"><?php echo e(Auth::user()->name); ?></span>
                    <small style="font-size: 0.75rem; color: #71717a;"><?php echo e(Auth::user()->roles->first()->name ?? 'User'); ?></small>
                </div>
            ...
            <div style="padding: 1.25rem 1.5rem; background: #fff;">
                ...
                <div style="margin-bottom: 1rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        ...
                        <p style="font-size: 0.9rem; font-weight: 500; color: #18181b; margin: 0;"><?php echo e(Auth::user()->name); ?></p>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 0.5rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        ...
                        <p style="font-size: 0.9rem; font-weight: 500; color: #18181b; margin: 0;"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                </div>
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 380px;">
        <div class="modal-content" style="border-radius: 0.75rem; border: 1px solid #e4e4e7; overflow: hidden;">
            ...
            <!-- Body -->
            <form id="changePasswordForm" method="POST" action="<?php echo e(route('change.password.update')); ?>">
                <?php echo csrf_field(); ?>
                <div style="padding: 1.25rem 1.5rem; background: #fff;">
...
</script><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>