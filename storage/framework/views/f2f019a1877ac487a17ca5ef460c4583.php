...
<div class="container-fluid py-4">
    ...
    <div class="shad-page-header">
        ...
        <div class="d-flex align-items-center" style="gap: 0.5rem;">
            <form action="<?php echo e(route('projects.export')); ?>" method="POST" class="m-0">
                <?php echo csrf_field(); ?>
            ...
            <div class="shad-stat-card">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="shad-stat-value"><?php echo e($stats['total']); ?></p>
                    </div>
            ...
            <div class="shad-stat-card" style="border-left: 4px solid #22c55e;">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="shad-stat-value" style="color: #22c55e;"><?php echo e($stats['green']); ?></p>
                    </div>
            ...
            <div class="shad-stat-card" style="border-left: 4px solid #f59e0b;">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="shad-stat-value" style="color: #f59e0b;"><?php echo e($stats['yellow']); ?></p>
                    </div>
            ...
            <div class="shad-stat-card" style="border-left: 4px solid #ef4444;">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="shad-stat-value" style="color: #ef4444;"><?php echo e($stats['red']); ?></p>
                    </div>
            ...
            <div class="table-responsive">
                <table class="shad-table">
                    ...
                    <tbody>
                        ...
                        <tr data-project-id="<?php echo e($project->id); ?>">
                            <td class="font-weight-bold"><?php echo e($project->name); ?></td>
                            <td><?php echo e(Str::limit($project->description, 50)); ?></td>
                            <td class="text-center" id="status-badge-<?php echo e($project->id); ?>">
                            ...
                            <td class="text-center">
                                <button class="shad-btn shad-btn-ghost btn-sm" 
                                        onclick="openDetailModal(<?php echo e($project->id); ?>)" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this project?');">
                                    <?php echo csrf_field(); ?>
...
<script>
    function openCreateModal() {
        ...
        document.getElementById('projectForm').action = '<?php echo e(route("projects.store")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\the_pulsepals\resources\views/projects/index.blade.php ENDPATH**/ ?>