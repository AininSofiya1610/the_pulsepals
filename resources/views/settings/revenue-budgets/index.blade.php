...
<div class="container-fluid py-4">
    ...
    <div class="shad-page-header">
        ...
        <form action="{{ route('settings.revenue-budgets.export') }}" method="POST" class="m-0">
            @csrf
    ...
    <div class="shad-card mb-4">
        ...
        <div class="shad-card-body">
            <form action="{{ route('settings.revenue-budgets.index') }}" method="GET" class="d-flex align-items-center gap-3">
    ...
    <div class="shad-card">
        <div class="shad-card-header" style="background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); border-radius: var(--radius-lg) var(--radius-lg) 0 0;">
            <h2 class="shad-card-title" style="color: #fff;">
                ...
                Monthly Budget Targets for {{ $selectedYear }}
            </h2>
        ...
        <div class="shad-card-body">
            <form action="{{ route('settings.revenue-budgets.update') }}" method="POST">
                @csrf
                <input type="hidden" name="year" value="{{ $selectedYear }}">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="shad-stat-value" id="totalBudget" style="color: #3b82f6;">
                                        RM {{ number_format(array_sum(array_column($monthlyBudgets, 'amount')), 0) }}
                                    </p>
                                </div>
    ...
    <div class="modal fade shad-modal" id="addYearModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('settings.revenue-budgets.year.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input 
                                type="number" 
                                name="year" 
                                class="shad-input @error('year') is-invalid @enderror" 
